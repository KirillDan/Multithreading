...
class SypplyAsyncExample {
	protected SypplyAsyncExample() {
	}
	...
	public static CompletableFuture<String> buyProduct(final String product) {
...
class AsyncComplexExample {
	protected AsyncComplexExample() {
	}
	...
	public static void thenComposeExample() throws Exception {
		CompletableFuture<Void> result = SypplyAsyncExample.buyProduct("Молоко")
				.thenCompose(a -> RunAsyncExample.goToTrash());
		iWork();
	}
	
	public static void thenCombineExample() throws Exception {
	    CompletableFuture<String> result = SypplyAsyncExample.buyProduct("Молоко")
	            .thenCombine(SypplyAsyncExample.buyProduct("Хлеб"), (r1, r2) -> "Куплены " + r1 + " и " + r2);
	    iWork();
	    System.out.println(result.get());
	}
	
	public static CompletableFuture<Void> washHands(final String name) {
	    return CompletableFuture.runAsync(() -> {
	        try {
	            TimeUnit.SECONDS.sleep(1);
	        } catch (InterruptedException e) {
	...
	public static CompletableFuture<String> whoWashHands(final String name) {
	    return CompletableFuture.supplyAsync(() -> {
	        try {
	            TimeUnit.SECONDS.sleep(1);
	        } catch (InterruptedException e) {
...
//			SypplyAsyncExample.supplyAsyncExample();
//			RunAsyncExample.thenRunExample();
//			SypplyAsyncExample.thenAcceptExample();
//			SypplyAsyncExample.thenApplyExample();
//			AsyncComplexExample.thenComposeExample();
//			AsyncComplexExample.thenCombineExample();
			AsyncComplexExample.anyOfExample();
//			AsyncComplexExample.allOfExample();
		} catch (Exception e) {
			e.printStackTrace();
		}
